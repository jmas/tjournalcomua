...
const Home: NextPage = () => {
  const content = useMemo(() => {
      ...
      return (
        <>
          ...
          <Text>
            ...
            частину україномовної аудиторії на новому проєкті.
          </Text>
          <Text>
    ...
    return (
      <>
        <Title order={1}>Это украинская версия TJournal 🇺🇦</Title>
        <Text>
        ...
        <Text>
          ...
          часть украиноговорящей аудитории на новом проекте.
        </Text>
        ...
        <Text>
          ...
          Goolge и создать чат в Телеграме. Поэтому дальше ты видишь кнопку,
